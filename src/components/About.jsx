      ...
      <div className='max-w-7xl mx-auto px-6'>
        <div className='text-center mb-20'>
          ...
          <p className='text-gray-500 mt-5 text-lg'>
            Knee Osteoarthritis care should start with your symptoms,
            <br /> your movement, and your goals.
          </p>
        </div>
        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          <div>
            <h3 className='text-5xl font-semibold leading-tight text-gray-900 max-w-md'>
              Make sense of your knee, one step at a time
            </h3>

            <p className='text-gray-500 mt-8 max-w-sm leading-8'>
              Bring together symptoms, imaging, and everyday movement so the
              next conversation feels more focused.
            </p>
            ...
            <div className='mt-28'>
              <h4 className='text-5xl font-semibold'>0 Steps</h4>

              <p className='text-gray-500 mt-2'>
                From Understanding to Personalized Carep plan
              </p>
            </div>
          </div>
          ...
          <div className='relative'>
            <div className='rounded-3xl overflow-hidden bg-gradient-to-br from-green-500 via-green-400 to-emerald-200 p-7'>
              <img
                src={dashboard}
                alt='Dashboard'
